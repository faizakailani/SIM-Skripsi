		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div class="border border-dark">
					<form action=editmahasiswaexec.php method=post enctype='multipart/form-data'>
						<?php
						...
						?>
							...
							<div style="margin-bottom: 2rem;">
								...
								<input type="text" class="form-control" name="NIM" id="inputNIM" required value="<?php echo $row['NIM'] ?>">
							</div>
							<div style="margin-bottom: 2rem;">
								<label for="inputNama" class="form-label">Nama</label>
								<input type="text" class="form-control" name="Nama" id="inputNama" required value="<?php echo $row['Nama'] ?>">
							</div>
							<div style="margin-bottom: 2rem;">
                            ...
                            images/<?php echo $row['Foto'] ?>" width="100px" height="100px" alt="foto" style="margin: 0 0 5px 10px"></a>
										<input type="text" class="form-control" name="Foto" id="inputFile" required value="<?php echo $row['Foto'] ?> " readonly>
								<?php }
								} ?>
								<a class="btn btn-success" style="color: white; font-weight: 5px" href="uploadimagemahasiswa.php?NIM=<?php echo $row['NIM'] ?>">Upload image</a>
							</div>
						<?php } ?>
