	...
	?>
		...
		<div class="panel panel-primary">
			<div class=" panel-heading">
				<h3 class="panel-title">TW Table</h3>
			</div>
			<div class="panel-body">
				<div class="border border-dark">
					<form action=editmastertw_tabeltw_hak_aksesexec.php method=post enctype='multipart/form-data'>
						<?php
						...
						?>
							...
							<div style="margin-bottom: 2rem;">
								...
								<input type="text" class="form-control" name="tabel" id="tabel" value="<?php echo $row['tabel'] ?>" aria-describedby="emailHelp" required>
							</div>
						<?php
						}
						?>
