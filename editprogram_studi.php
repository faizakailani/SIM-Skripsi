		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div class="border border-dark">
					<form action="editprogram_studiexec.php" method="post">
						<?php
						...
						?>
							...
							<div style="margin-bottom: 2rem;">
								...
								<input type="text" class="form-control" name="Kode" value="<?php echo $row['Kode'] ?>" id="inputKode" aria-describedby="emailHelp" required>
							</div>
							<div style="margin-bottom: 2rem;">
								<label for="inputProdi" class="form-label">Program Studi</label>
								<input type="text" class="form-control" name="Program_Studi" value="<?php echo $row['Program_Studi'] ?>" id="inputProdi" required>
							</div>
							<div style="margin-bottom: 2rem;">
