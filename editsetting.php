		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div class="border border-dark">
					<form action=editsettingexec.php method=post enctype='multipart/form-data'>
						<?php
						...
						?>
							...
							<div style="margin-bottom: 2rem;">
								...
								<textarea class='form-control' name='Alamat' cols=20 rows=2><?php echo $row['Alamat'] ?></textarea>
							</div>
							<div style="margin-bottom: 2rem;">
								<label for="IpAddress" class="form-label">Telepon</label>
								<input type="text" class="form-control" name="Telepon" id="Telepon" value="<?php echo $row['Telepon'] ?>" required>
							</div>
							<div style="margin-bottom: 2rem;">
                            ...
                            images/<?php echo $row['Logo'] ?>" width="100px" height="100px" alt="logo" style="margin: 0 0 5px 10px"></a>
										<input type="text" class="form-control" name="Logo" id="upload_file" required value="<?php echo $row['Logo'] ?> " readonly>
								<?php }
								} ?>
								<a class="btn btn-success" style="color: white; font-weight: 5px" href="uploadimagesetting.php?ID=<?php echo $row['ID'] ?>">Upload image</a>
							</div>
						<?php } ?>
