	...
	?>
		...
		<div class="panel panel-primary">
			<div class=" panel-heading">
				<h3 class="panel-title">Tambah Log TW</h3>
			</div>
			<div class="panel-body">
				<div class="border border-dark">
					<form action=insertlogtwexec.php method=post enctype='multipart/form-data'>
						...
						<div style="margin-bottom: 2rem;">
							...
							<input type="text" class="form-control" name="IpAddress" id="IpAddress" required>
						</div>

						<div style="margin-bottom: 2rem;">
							<label for="Information" class="form-label">Information</label>
							<textarea class='form-control' name='Information' cols=20 rows=2></textarea>
						</div>
