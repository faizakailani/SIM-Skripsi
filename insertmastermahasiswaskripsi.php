...
<div id="page-wrapper" style="padding-top: 2rem;">
    ...
    <div class="panel panel-primary">
        <div class=" panel-heading">
            <h3 class="panel-title">Tambah Master Mahasiswa/Skripsi</h3>
        </div>
        <div class="panel-body">
            <div class="border border-dark">
                <form action=insertmastermahasiswaskripsiexec.php method=post enctype='multipart/form-data'>
                    <div style="margin-bottom: 2rem;">
                        <label for="inputNIDN" class="form-label">NIM</label>
                        <input type="text" class="form-control" name="NIM" id="inputNIDN" aria-describedby="emailHelp"
                            required>
                    </div>
                    <div style="margin-bottom: 2rem;">
