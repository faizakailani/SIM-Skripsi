    ...
    ?>
        ...
        <div class="panel panel-primary">
            <div class=" panel-heading">
                <h3 class="panel-title">Tambah Master Program Studi</h3>
            </div>
            <div class="panel-body">
                <div class="border border-dark">
                    <form action=insertmasterprogram_studimahasiswaexec.php method=post enctype='multipart/form-data'>
                        <div style="margin-bottom: 2rem;">
                            <label for="inputKode" class="form-label">Kode</label>
                            <input type="text" class="form-control" name="Kode" id="inputKode" aria-describedby="emailHelp" required>
                        </div>
                        <div style="margin-bottom: 2rem;">
                            <label for="inputProdi" class="form-label">Program Studi</label>
                            <input type="text" class="form-control" name="Program_Studi" id="inputProdi" required>
                        </div>
                        <div style="margin-bottom: 2rem;">
                            ...
                            <select name="Kaprodi" class="form-control" required>
                                ...
                                while ($r = mysqli_fetch_array($result)) {
                                    echo "<option value='" . $r['NIDN'] . "|" . $r['Nama'] . "'>" . $r['NIDN'] . " | " . $r['Nama'] . "</option>";
                                } ?>
                            </select>
                        </div>
