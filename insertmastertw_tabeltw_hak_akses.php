		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div class="border border-dark">
					<form action=insertmastertw_tabeltw_hak_aksesexec.php method=post enctype='multipart/form-data'>
						<div style="margin-bottom: 2rem;">
							<label for="tabel" class="form-label">Tabel</label>
							<input type="text" class="form-control" name="tabel" id="tabel" aria-describedby="emailHelp" required>
						</div>
