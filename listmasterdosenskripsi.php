...
echo "<br><a href=insertmasterdosenskripsi.php><button type='button' class='btn btn-light'><font face=Verdana color=black size=2><i class='fa fa-plus'></i>&nbsp;Insert</font></button></a><br>";
echo "</div>";

//cari tabel
echo "<div class='col-md-6 mb-20 text-right' >";
echo "<br><form action=listmasterdosenskripsi.php method=post class='form-inline'>";
...
<th><font face=Verdana color=white size=2><b>NIDN</b></font></th>
