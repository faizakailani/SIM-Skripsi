...
?>
<?php
echo "<br><h4>Mahasiswa Skripsi</h4><br>";

echo "<div class='row'>";
echo "<div class='col-md-6 mb-20'>"; 
echo "<a href=insertmastermahasiswaskripsi.php><button type='button' class='btn btn-light'><font face=Verdana color=black size=2><i class='fa fa-plus'></i>&nbsp;Insert</font></button></a><br>";
echo "</div>";

//cari tabel
echo "<div class='col-md-6 mb-20 text-right' >";
echo "<form action=listmastermahasiswaskripsi.php method='post' class='form-inline'>";
...
<tr bgcolor=337ab7> 
<th><font face=Verdana color=white size=2><b>NIM</b></font></th>
<th><font face=Verdana color=white size=2><b>Nama</b></font></th>
<th><font face=Verdana color=white size=2><b>Program_Studi</b></font></th>
<th class='align-middle'><font face=Verdana color=white size=2><b>Foto</b></font></th>
<th class='align-middle'><font face=Verdana color=white size=2><b>Aksi</b></font></th>
</tr>";
$warna = 0;
...
echo "<td class='align-middle'><a class=linklist href=listmastermahasiswaskripsidetail.php?NIM=" . $row['NIM'] . "><button type='button' class='btn btn-success'><font face=Verdana color=white size=1>Kelola Skripsi</font></button></a>";
echo "<a class=linklist href=viewmastermahasiswaskripsi.php?NIM=" . $row['NIM'] . "><button type='button' class='btn btn-warning' data-toggle='tooltip' data-placement='top' title='Lihat data'><font face=Verdana size=1><i class='fa fa-eye'></i></font></button></a>";
echo "<a class=linklist href=editmastermahasiswaskripsi.php?NIM=" . $row['NIM'] . "><button type='button' class='btn btn-primary' data-toggle='tooltip' data-placement='top' title='Edit data'><font face=Verdana size=1><i class='fa fa-edit'></i></font></button></a>";
echo "<a class=linklist href=deletemastermahasiswaskripsi.php?NIM=" . $row['NIM'] . " onclick=\"return confirm('Are you sure you want to delete this data?')\"><button type='button' class='btn btn-danger' data-toggle='tooltip' data-placement='top' title='Hapus data'><font face=Verdana size=1><i class='fa fa-trash'></i></font></button></a></td";
echo "</tr>";
}
echo "</table><br><br>";
echo "</div>";
