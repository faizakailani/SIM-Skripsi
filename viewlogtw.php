                    ...
                    <form>
                        ...
                        ?>
                            <div style="margin-bottom: 2rem;">
                                ...
                                <input type="datetime-local" class="form-control" name="Time" id="Time" value="<?php echo $row['Time'] ?>" required readonly>
                            </div>
                            <div style="margin-bottom: 2rem;">
                                <label for="User" class="form-label">User</label>
                                <input type="text" class="form-control" name="User" id="User" value="<?php echo $row['User'] ?>" required readonly>
                            </div>
                            <div style="margin-bottom: 2rem;">
                                <label for="IpAddress" class="form-label">IP Address</label>
                                <input type="text" class="form-control" name="IpAddress" id="IpAddress" value="<?php echo $row['IpAddress'] ?>" required readonly>
                            </div>

                            <div style="margin-bottom: 2rem;">
                                <label for="Information" class="form-label">Information</label>
                                <div style="margin-bottom: 2rem;">
                                    <span><?php echo $row['Information'] ?></span>
                                </div>
                            </div>
                        ...
                        ?>
                        <a href=listlogtw.php><button type="button" class="btn btn-warning">Back</button></a>
                    </form>
                </div>
            </div>
        </div>
